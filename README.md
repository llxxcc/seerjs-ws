# seer websocket interface (seerjs-ws)

Pure JavaScript seer websocket library for node.js and browsers. Can be used to easily connect to and obtain data from the seer blockchain via public apis or local nodes.

Credit for the original implementation goes to [jcalfeee](https://github.com/jcalfee).

[![npm version](https://img.shields.io/npm/v/seerjs-ws.svg?style=flat-square)](https://www.npmjs.com/package/seerjs-ws)
[![npm downloads](https://img.shields.io/npm/dm/seerjs-ws.svg?style=flat-square)](https://www.npmjs.com/package/seerjs-ws)
...
```
<script type="text/javascript" src="https://cdn.rawgit.com/seer/seerjs-ws/build/seerjs-ws.js" />
```

A variable seer_ws will be available in window.

For use in a webpack/browserify context, see the example below for how to open a websocket connection to the Openledger API and subscribe to any object updates:

```
var {Apis} = require("seerjs-ws");
Apis.instance("wss://seer.openledger.info/ws", true).init_promise.then((res) => {
...
This is a non-exhaustive list of endpoints available from the witness_node executable, which provides the API server of seer.

## database_api
https://github.com/seer/seer-core/blob/master/libraries/app/database_api.cpp
